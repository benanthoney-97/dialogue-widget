...
import { useModalPortal } from "@/app/components/ModalPortalContext";
...
export type CampaignPrepAgentProps = Props;
...
export default function CampaignPrepAgent(props: Props) {
  const {
  ...
  const containerTopOffset = isPanelExpanded ? (isNarrow ? 24 : 48) : 0;
  ...
  margin: isPanelExpanded ? `${containerTopOffset}px 0 0` : "0 auto",
