...
export default function DocExperience({ slug }: DocExperienceProps) {
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          height: "100dvh",
          WebkitOverflowScrolling: mounted && isTouch
            ? ("touch" as any)
            : undefined,
